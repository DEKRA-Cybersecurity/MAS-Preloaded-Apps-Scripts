...
def main():
    ...
    if semgrep:
        semgrep_scan(wdir, apk_hash, package_name, actual_timestamp)
    else:
        check_app(wdir, apk, apk_hash, package_name, internet, semgrep, actual_timestamp)
