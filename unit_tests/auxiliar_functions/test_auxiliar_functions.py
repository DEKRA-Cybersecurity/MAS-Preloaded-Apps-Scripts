...
from utils.auxiliar_functions import check_signature, check_debuggable, check_package_name, get_hash, get_suid_from_manifest, check_network_applies, get_version_name, parse_timestamp
...
class TestAuxiliarFunctions(unittest.TestCase):
    ...
    def test_check_signature(self):
        ...
        output = check_signature(
            self.wdir, self.apk, self.apk_hash, self.package_name, self.uuid_execution)
    ...
    def test_check_debuggable(self):
        ...
        output = check_debuggable(
            self.wdir, self.apk_hash, self.package_name, self.uuid_execution)
    ...
    def test_check_network_applies(self):
        ...
        output = check_network_applies(
            self.wdir, self.apk_hash, self.internet, self.uuid_execution)
